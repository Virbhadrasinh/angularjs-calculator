CalculatorApp.service('CalculatorService', function(MathService){
	this.getEventDetails = function(button, calculatorData){
	...
	this.ckeckConditions = function(button, calculatorData){
	...
	this.checkOperatorConditions = function(button, calculatorData){
		var operator = button.actualValue;
	...
	this.clearCalculatorData = function(calculatorData){
		calculatorData.displayData = undefined;
